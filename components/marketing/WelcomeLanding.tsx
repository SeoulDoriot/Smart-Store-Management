...
function SectionPill({
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-black/[0.08] bg-white/[0.84] px-4 py-2 text-sm font-medium text-zinc-700 shadow-[0_10px_26px_rgba(15,23,42,0.06)] backdrop-blur">
...
function DeskNotebook() {
  return (
    <div className="absolute bottom-[15%] right-[5%] z-10 w-[16%] min-w-[88px]">
      <div className="relative h-5 w-full rounded-[0.7rem] bg-white/[0.95] shadow-[0_12px_24px_rgba(15,23,42,0.08)]" />
...
function DeskGlasses() {
  return (
    <svg
      className="absolute bottom-[19%] left-[8%] z-20 h-auto w-[12%] min-w-[86px] text-[#414b59]/[0.72]"
      viewBox="0 0 180 80"
      fill="none"
      aria-hidden="true"
    >
            ...
            <div className="relative mx-auto flex h-full max-w-[86rem] items-start justify-center pt-5 sm:pt-6 lg:pt-8">
              ...
              <div className="relative z-10 flex w-full max-w-5xl flex-col items-center gap-4 text-center lg:gap-5">
                ...
                <div style={readDescStyle} className="w-full max-w-2xl">
                  <div className="rounded-[2rem] border border-[#dbe5f8] bg-white/[0.88] p-5 shadow-[0_22px_50px_rgba(15,23,42,0.06)] backdrop-blur">
                ...
                <div className="relative w-full max-w-[920px] lg:max-w-[980px]" style={readMediaStyle}>
                  ...
                  <div className="absolute left-[6%] top-[17%] h-32 w-32 rounded-full bg-[#dce9ff]/[0.75] blur-3xl" />
                  <div className="absolute right-[8%] top-[12%] h-40 w-40 rounded-full bg-[#f2f6ff] blur-3xl" />
                  <div className="absolute bottom-[13%] left-[18%] h-[12%] w-[26%] rotate-[8deg] rounded-[1.4rem] bg-white/[0.82] shadow-[0_16px_34px_rgba(15,23,42,0.05)]" />
                  <div className="absolute bottom-[11%] right-[11%] h-[11%] w-[22%] -rotate-[10deg] rounded-[1.25rem] bg-white/[0.86] shadow-[0_16px_34px_rgba(15,23,42,0.05)]" />
                  ...
                  />
                  <div
                    className="absolute left-[47%] top-[55.5%] z-20 h-[2px] rounded-full bg-[#bfd0fb]/[0.95] blur-[0.5px]"
                    style={{
                  ...
                  />
                  <div
                    className="absolute left-[49%] top-[57.1%] z-20 h-[2px] rounded-full bg-[#d6e2ff]/[0.9] blur-[0.5px]"
                    style={{
                  ...
                  />
                  <div
                    className="absolute left-[48%] top-[56%] z-20 h-3 w-24 rounded-full bg-[#cad8fb]/[0.85] blur-[6px]"
                    style={{
            ...
            <div className="relative mx-auto flex h-full max-w-[86rem] items-start justify-center pt-5 sm:pt-6 lg:pt-8">
              ...
              <div className="relative z-10 flex w-full max-w-5xl flex-col items-center gap-4 text-center lg:gap-5">
                ...
                <div style={exploreDescStyle} className="relative w-full max-w-[78rem]">
                  <div className="absolute left-[0%] top-[6%] z-20 hidden rounded-full border border-[#e6ebf4] bg-white/[0.88] px-6 py-3 text-[clamp(1rem,1.4vw,1.25rem)] font-medium text-[#8f97a8] shadow-[0_14px_34px_rgba(15,23,42,0.06)] backdrop-blur md:block">
                    Mystery
                  </div>
                  <div className="absolute left-[4%] top-[116%] z-20 hidden rounded-full border border-[#e6ebf4] bg-white/[0.88] px-6 py-3 text-[clamp(1rem,1.4vw,1.25rem)] font-medium text-[#8f97a8] shadow-[0_14px_34px_rgba(15,23,42,0.06)] backdrop-blur md:block">
                    Fantasy
                  </div>
                  <div className="absolute right-[0%] top-[6%] z-20 hidden rounded-full border border-[#e6ebf4] bg-white/[0.88] px-6 py-3 text-[clamp(1rem,1.4vw,1.25rem)] font-medium text-[#8f97a8] shadow-[0_14px_34px_rgba(15,23,42,0.06)] backdrop-blur md:block">
                    Self-improvement
                  </div>
                  <div className="absolute right-[4%] top-[116%] z-20 hidden rounded-full border border-[#e6ebf4] bg-white/[0.88] px-6 py-3 text-[clamp(1rem,1.4vw,1.25rem)] font-medium text-[#8f97a8] shadow-[0_14px_34px_rgba(15,23,42,0.06)] backdrop-blur md:block">
                    Sci-Fi
                  </div>
                  <div className="relative z-10 mx-auto max-w-3xl rounded-[2rem] border border-[#dfe8df] bg-white/[0.88] px-6 py-4 shadow-[0_22px_50px_rgba(15,23,42,0.06)] backdrop-blur sm:px-8 sm:py-5">
                ...
                <div className="relative h-[25rem] w-full max-w-[820px] lg:h-[28rem] lg:max-w-[860px]" style={exploreMediaStyle}>
                  ...
                  <Image
                    ...
                    width={1536}
                    height={1024}
                    className="absolute bottom-[0%] right-[5%] z-10 h-auto w-[38%] object-contain opacity-[0.92] sm:w-[40%]"
