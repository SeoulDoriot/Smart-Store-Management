...
const BRANDS: Brand[] = [
  {
    ...
    sub: "Anua",
    label: "K-Beauty",
    gradient: "from-[#F8EDE3] to-[#EAD6C3]",
    text: "text-[#9A5535]",
    objectTints: ["bg-white/90", "bg-[#E9CFB6]/80", "bg-white/75"],
  },
  {
    name: "COSRX",
    initial: "CX",
    sub: "COSRX",
    label: "K-Beauty",
    gradient: "from-[#E5F3EB] to-[#CCE7D6]",
    text: "text-[#2A6645]",
    objectTints: ["bg-white/90", "bg-[#BFE0CC]/80", "bg-white/75"],
  },
  {
    ...
    label: "K-Beauty",
    gradient: "from-[#F8F2DE] to-[#ECDFBB]",
    text: "text-[#806830]",
    objectTints: ["bg-white/90", "bg-[#E4D29A]/80", "bg-white/75"],
  },
  {
    name: "Skin1004",
    initial: "S1",
    sub: "Skin1004",
    label: "K-Beauty",
    gradient: "from-[#ECEAF8] to-[#D7D3F0]",
    text: "text-[#44408A]",
    objectTints: ["bg-white/90", "bg-[#C7C2EC]/80", "bg-white/75"],
  },
  {
    name: "CeraVe",
    initial: "CV",
    sub: "CeraVe",
    label: "Derma",
    gradient: "from-[#E3F1EF] to-[#CBE5E1]",
    text: "text-[#246460]",
    objectTints: ["bg-white/90", "bg-[#BBDED9]/80", "bg-white/75"],
  },
  {
    name: "The Ordinary",
    initial: "TO",
  ...
  },
  {
    ...
    sub: "Some+By+Mi",
    label: "K-Beauty",
    gradient: "from-[#F8E8F1] to-[#EFCFE0]",
    text: "text-[#943060]",
    objectTints: ["bg-white/90", "bg-[#E7BAD3]/80", "bg-white/75"],
  },
  {
    name: "Laneige",
    initial: "L",
    sub: "Laneige",
    label: "K-Beauty",
    gradient: "from-[#E2EBF8] to-[#CBDAF1]",
    text: "text-[#245090]",
    objectTints: ["bg-white/90", "bg-[#BBD0EE]/80", "bg-white/75"],
  },
];
